...
def Run(cli_args=None):
    """
    Trigger all branches stored in a file generated by :py:func:`depinning_inertia_2024.Trigger.Generate`.
...
def MergeBatch(cli_args=None):
    """
    Run :py:func:`depinning_inertia_2024.Trigger.Merge` on a batch of files.
    The usage is::
