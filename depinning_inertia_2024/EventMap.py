"""
Rerun step to extract event map.
...
def Run(cli_args=None):
    ...
    *   ``S``: Size (signed) of the yielding event.
    ...
    Tip: use ``"--smax"`` to truncate when (known) S is reached to not waste time on
    the final stage of energy minimisation.
    """
    parser = _Run_parser()
...
def Paraview(cli_args=None):
    ...
    The input is the output of :py:func:`depinning_inertia_2024.EventMap.Run`.
    """
